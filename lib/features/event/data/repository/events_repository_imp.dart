...
class EventsRepositoryImp extends AbstractEventsRepository{
  var remoteSource = Get.put<AbstractEventsRemoteDateSource>(EventsRemoteDataSourceImp());
  ...
  @override
  Future<Either<Failure, EventEntity>> getSearchedEvents({required EventSearchRequestModel searchRequestModel}) {
    // TODO: implement getSearchedEvents
    return remoteSource.getSearchedEvents(searchRequestModel: searchRequestModel);
  }
