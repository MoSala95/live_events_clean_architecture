...
class EventsSearchUseCase implements UseCase<EventEntity, EventSearchRequestModel> {
  AbstractEventsRepository eventsRepositoryRepository =
  Get.put<AbstractEventsRepository>(EventsRepositoryImp());

  @override
  Future<Either<Failure, EventEntity>> call(EventSearchRequestModel searchRequestModel) {
    return eventsRepositoryRepository.getSearchedEvents(searchRequestModel: searchRequestModel);
  }
}